    ...
    return (
      <div className="relative w-full group/input">
        <input
          type={inputType}
          className={cn(
            "flex h-11 w-full rounded-xl border border-border/40 bg-background/50 px-4 py-2 text-sm placeholder:text-muted-foreground/40 focus-visible:outline-none focus-visible:border-foreground/40 focus-visible:ring-2 focus-visible:ring-foreground/5 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-300 ease-[cubic-bezier(0.23,1,0.32,1)]",
            isPassword && "pr-10",
            className
          )}
          ref={ref}
